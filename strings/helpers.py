...
/antinsfw [on ᴏʀ enable] : ᴛᴜʀɴ ᴏɴ ᴀɴᴛɪ-ɴsғᴡ sʏsᴛᴇᴍ.
/antinsfw [off ᴏʀ disable] : ᴛᴜʀɴ ᴏғғ ᴀɴᴛɪ-ɴsғᴡ sʏsᴛᴇᴍ.
"""

HELP_18 = """
**🤖 ᴀɴᴛɪ-ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs :**

/antibot [on ᴏʀ enable] : ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴋɪᴄᴋ ɴᴇᴡ ʙᴏᴛs.
/antibot [off ᴏʀ disable] : ᴀʟʟᴏᴡ ʙᴏᴛs ᴛᴏ ᴊᴏɪɴ.
"""

HELP_19 = """
**✏️ ᴀɴᴛɪ-ᴇᴅɪᴛ ᴄᴏᴍᴍᴀɴᴅs :**

/antiedit [on ᴏʀ enable] : ᴅᴇʟᴇᴛᴇ/ᴡᴀʀɴ ɪғ ᴀ ᴍᴇssᴀɢᴇ ɪs ᴇᴅɪᴛᴇᴅ.
/antiedit [off ᴏʀ disable] : ᴛᴜʀɴ ᴏғғ ᴀɴᴛɪ-ᴇᴅɪᴛ.
"""

HELP_20 = """
**🗑 ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ ᴄᴏᴍᴍᴀɴᴅs :**

/autodelete [on ᴏʀ enable] : ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ sᴇʀᴠɪᴄᴇ ᴍᴇssᴀɢᴇs.
...
/antiabuse [on ᴏʀ enable] : ᴛᴜʀɴ ᴏɴ ᴀɴᴛɪ-ᴀʙᴜsᴇ.
/antiabuse [off ᴏʀ disable] : ᴛᴜʀɴ ᴏғғ ᴀɴᴛɪ-ᴀʙᴜsᴇ.
/addword [ᴡᴏʀᴅ] : ᴀᴅᴅ ᴀ ʙᴀᴅ ᴡᴏʀᴅ ᴛᴏ ᴛʜᴇ ʟɪsᴛ.
/delword [ᴡᴏʀᴅ] : ʀᴇᴍᴏᴠᴇ ᴀ ᴡᴏʀᴅ.
/badwords : sʜᴏᴡs ʙʟᴏᴄᴋᴇᴅ ᴡᴏʀᴅs.
"""
