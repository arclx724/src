...
async def security_helper_cb(client, CallbackQuery, _):
    ...
    if cmd == "antinuke":
        ...
        text = (
            "**🤬 ᴀɴᴛɪ-ᴀʙᴜsᴇ ᴄᴏᴍᴍᴀɴᴅs :**\n\nᴋᴇᴇᴘ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴄʟᴇᴀɴ ʙʏ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛɪɴɢ ᴀʙᴜsɪᴠᴇ ᴡᴏʀᴅs ᴀɴᴅ sᴡᴇᴀʀ ᴡᴏʀᴅs.\n\n/antiabuse [on ᴏʀ enable] : ᴛᴜʀɴ ᴏɴ ᴀɴᴛɪ-ᴀʙᴜsᴇ sʏsᴛᴇᴍ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ.\n/antiabuse [off ᴏʀ disable] : ᴛᴜʀɴ ᴏғғ ᴀɴᴛɪ-ᴀʙᴜsᴇ sʏsᴛᴇᴍ.\n/addword [ᴡᴏʀᴅ] : ᴀᴅᴅ ᴀ ʙᴀᴅ ᴡᴏʀᴅ ᴛᴏ ᴛʜᴇ ғɪʟᴛᴇʀ ʟɪsᴛ.\n/delword [ᴡᴏʀᴅ] : ʀᴇᴍᴏᴠᴇ ᴀ ᴡᴏʀᴅ ғʀᴏᴍ ᴛʜᴇ ғɪʟᴛᴇʀ ʟɪsᴛ.\n/badwords : sʜᴏᴡs ᴛʜᴇ ʟɪsᴛ ᴏғ ʙʟᴏᴄᴋᴇᴅ ᴀʙᴜsɪᴠᴇ ᴡᴏʀᴅs ɪɴ ᴛʜᴇ ᴄʜᴀᴛ."
        )
        ...
        text = (
            "**✏️ ᴀɴᴛɪ-ᴇᴅɪᴛ ᴄᴏᴍᴍᴀɴᴅs :**\n\nᴘʀᴇᴠᴇɴᴛ sᴄᴀᴍᴍᴇʀs ғʀᴏᴍ ᴇᴅɪᴛɪɴɢ ᴍᴇssᴀɢᴇs ᴛᴏ ᴀᴅᴅ sᴘᴀᴍ ʟɪɴᴋs ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴛʜᴇᴍ.\n\n/antiedit [ᴏɴ ᴏʀ ᴏғғ] : ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ᴀɴᴛɪ-ᴇᴅɪᴛ sʏsᴛᴇᴍ.\n/ᴀᴜᴛʜᴇᴅɪᴛ [ʀᴇᴘʟʏ/@ᴜsᴇʀ/ɪᴅ] : ᴇxᴇᴍᴘᴛ ᴀ ᴜsᴇʀ ғʀᴏᴍ ᴀɴᴛɪ-ᴇᴅɪᴛ.\n/ᴜɴᴀᴜᴛʜᴇᴅɪᴛ [ʀᴇᴘʟʏ/@ᴜsᴇʀ/ɪᴅ/ᴀʟʟ] : ʀᴇᴍᴏᴠᴇ ᴜsᴇʀ(s) ғʀᴏᴍ ᴇxᴇᴍᴘᴛɪᴏɴ."
        )

    elif cmd == "autodelete":
        text = (
            "**🗑 ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ ᴄᴏᴍᴍᴀɴᴅs :**\n\nᴋᴇᴇᴘ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴄʟᴇᴀɴ ʙʏ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛɪɴɢ ᴍᴇssᴀɢᴇs.\n\n/autodelete [on ᴏʀ enable] : ᴛᴜʀɴ ᴏɴ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ ғᴏʀ sᴇʀᴠɪᴄᴇ ᴍᴇssᴀɢᴇs (ʟɪᴋᴇ 'ᴜsᴇʀ ᴊᴏɪɴᴇᴅ' ᴏʀ 'ᴜsᴇʀ ʟᴇғᴛ').\n/autodelete [off ᴏʀ disable] : ᴛᴜʀɴ ᴏғғ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ.\n\n*(ɴᴏᴛᴇ: sᴏᴍᴇ ʙᴏᴛs ᴀʟsᴏ sᴜᴘᴘᴏʀᴛ ᴛɪᴍᴇ-ʙᴀsᴇᴅ ᴅᴇʟᴇᴛɪᴏɴ ʟɪᴋᴇ /autodelete 5m)*."
        )
